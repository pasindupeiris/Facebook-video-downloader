...
const Navigation = () => {
  ...
  const style = 'xl:flex md:flex lg:flex sm:flex xsm:grid items-center justify-around w-[100%] text-white font-semibold gap-5 bg-[#275eea] xsm:absolute xsm:top-[5.9rem] xsm:gap-14 xsm:p-4 xsm:left-0';

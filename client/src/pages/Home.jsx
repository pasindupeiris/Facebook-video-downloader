                ...
                <div className="flex items-center justify-center mt-4">
                    ...
                    <div className="rounded-md p-5">
                        <div className="flex border-2 border-[#275eea] rounded-md">
                            ...
                            <input type="text" className="w-[500px]  border-[#275eea] rounded-md  bg-white p-4 text-base  outline-0  " placeholder="Enter Video Link Here..." id="" />
                            <div className="flex w-10 items-center justify-center rounded-tl-md rounded-bl-md border-r border-[#9a9c9fbf] ">
                                <BiPaste className=' text-xl text-slate-600' />
                            </div>
